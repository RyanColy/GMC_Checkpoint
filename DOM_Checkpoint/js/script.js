// ============================================================
// OOP Shopping Cart - Checkpoint
// This file implements a fully functional shopping cart using
// the Object-Oriented Programming (OOP) approach with ES6 classes.
// Features: add/remove items, delete with confirmation dialog,
// like toggle, animated total update, and empty cart message.
// ============================================================
...
// ============================================================
// OOP Tests (console)
// Test the OOP classes directly without relying on the DOM.
// Open the browser DevTools console (F12) to see the output.
// ============================================================

console.log("--- OOP Tests ---");

// 1. Create two test products
const testProduct1 = new Product(10, "Hat", 30);
const testProduct2 = new Product(11, "Scarf", 15);

// 2. Create an isolated test cart (separate from the live page cart)
const testCart = new ShoppingCart();

// 3. Add items: Hat twice, Scarf once
testCart.addItem(testProduct1); // Hat x1
testCart.addItem(testProduct1); // Hat x2
testCart.addItem(testProduct2); // Scarf x1

// 4. Display the cart — Expected: Hat x2 ($60), Scarf x1 ($15), Total: $75
testCart.displayCart();

// 5. Remove one Hat — Expected: Hat x1 ($30), Scarf x1 ($15), Total: $45
testCart.removeItem(testProduct1.id);
testCart.displayCart();

// 6. Edge case: remove a product with an id that does not exist
// Expected: a console.warn message
testCart.removeItem(99);

// 7. Edge case: delete all remaining items, then display the empty cart
testCart.deleteItem(testProduct1.id);
testCart.deleteItem(testProduct2.id);
testCart.displayCart(); // Expected: "The cart is empty."
