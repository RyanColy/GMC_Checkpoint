...
import useTrailerLink from '../hooks/useTrailerLink';
...
function AddMovieForm({ onAdd, genres, isOpen, setIsOpen }) {
  ...
  const { trailerLink, handleTrailerChange, resetTrailerLink } = useTrailerLink();
  ...
  function handleSubmit(e) {
    ...
    setError('');
    onAdd({ title, description, posterURL, rating: r, genre, trailerLink });
            ...
            <div className="amf-card__body">
              <div className="amf-layout">
                ...
                <form className="amf-fields" onSubmit={handleSubmit}>
                  ...
                  <div className="amf-field">
                    <label className="amf-label">Trailer Link (YouTube)</label>
                    <input
                      className="amf-input"
                      type="text"
